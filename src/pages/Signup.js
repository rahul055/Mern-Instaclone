...
const Signup = () => {
  ...
  return (
    <div className="container flex mx-auto max-w-screen-md justify-center items-center h-screen">
      <div className="flex flex-col items-center bg-white w-10/12 md:w-6/12  p-4 border md:border-gray-400 rounded mb-4">
        ...
        <div className="flex justify-center items-center flex-col w-full bg-white p-3 border border-gray-400 rounded">
          <p className="text-sm">
            ...
            <Link to={linkTo.LOGIN} className="text-blue-500 text-sm font-bold">
              {" "}
              Login
            </Link>
          </p>
